...
class Efimero:
    ...
    def rechazar(self,solicitud):
        ...
        if ciudadano.intentos == 5:
            ...
            admin = usuarios.usuario.Administrador()
    ...
    def crear_ciudadano(cls, cuil, telefono):
        ...
        for fila in reader:
            if fila[1] == telefono and fila [2] == cuil:
                nombre = fila[0]
                return usuarios.usuario.Ciudadano(nombre, telefono, cuil)
        Anses.close()
